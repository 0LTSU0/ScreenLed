...
#if defined(WIN32)
    screenCaptureWorkerWindows m_screenCapWorker = screenCaptureWorkerWindows(m_gConfPath);
#else
    screenCaptureWorkerLinux m_screenCapWorker = screenCaptureWorkerLinux();
#endif
